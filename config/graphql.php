...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'anime' => \App\GraphQL\Queries\Anime\AnimeQuery::class,
                'animes' => \App\GraphQL\Queries\Anime\AnimesQuery::class,
                'category' => \App\GraphQL\Queries\Category\CategoryQuery::class,
                'categories' => \App\GraphQL\Queries\Category\CategoriesQuery::class,
            ],
            'mutation' => [
                'createAnime' => \App\GraphQL\Mutations\Anime\CreateAnimeMutation::class,
                'updateAnime' => \App\GraphQL\Mutations\Anime\UpdateAnimeMutation::class,
                'deleteAnime' => \App\GraphQL\Mutations\Anime\DeleteAnimeMutation::class,
